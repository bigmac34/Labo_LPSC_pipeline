...
set rc [catch {
  ...
  add_files -quiet C:/Users/Jeremie/Dropbox/Master/Cours/Semestre2/LPSC/Labo/mandelbrot_pipeline/mandelbrot_pipeline.runs/synth_2/mse_mandelbrot.dcp
...
set rc [catch {
  ...
  create_report "impl_2_opt_report_drc_0" "report_drc -file mse_mandelbrot_drc_opted.rpt -pb mse_mandelbrot_drc_opted.pb -rpx mse_mandelbrot_drc_opted.rpx"
...
set rc [catch {
  ...
  create_report "impl_2_place_report_io_0" "report_io -file mse_mandelbrot_io_placed.rpt"
  create_report "impl_2_place_report_utilization_0" "report_utilization -file mse_mandelbrot_utilization_placed.rpt -pb mse_mandelbrot_utilization_placed.pb"
  create_report "impl_2_place_report_control_sets_0" "report_control_sets -verbose -file mse_mandelbrot_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_2_route_report_drc_0" "report_drc -file mse_mandelbrot_drc_routed.rpt -pb mse_mandelbrot_drc_routed.pb -rpx mse_mandelbrot_drc_routed.rpx"
  create_report "impl_2_route_report_methodology_0" "report_methodology -file mse_mandelbrot_methodology_drc_routed.rpt -pb mse_mandelbrot_methodology_drc_routed.pb -rpx mse_mandelbrot_methodology_drc_routed.rpx"
  create_report "impl_2_route_report_power_0" "report_power -file mse_mandelbrot_power_routed.rpt -pb mse_mandelbrot_power_summary_routed.pb -rpx mse_mandelbrot_power_routed.rpx"
  create_report "impl_2_route_report_route_status_0" "report_route_status -file mse_mandelbrot_route_status.rpt -pb mse_mandelbrot_route_status.pb"
  create_report "impl_2_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file mse_mandelbrot_timing_summary_routed.rpt -rpx mse_mandelbrot_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_2_route_report_incremental_reuse_0" "report_incremental_reuse -file mse_mandelbrot_incremental_reuse_routed.rpt"
  create_report "impl_2_route_report_clock_utilization_0" "report_clock_utilization -file mse_mandelbrot_clock_utilization_routed.rpt"
