...
#
# Generated by Vivado on Tue May 22 17:38:51 +0200 2018
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_0 xil_defaultlib.dist_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dist_mem_gen_0 -key {Behavioral:sim_3:Functional:dist_mem_gen_0} -tclbatch cmd.tcl -log simulate.log
}
